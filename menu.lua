    ...
    --    love.graphics.setColor(frontcolor)
      ...
      elseif len(menu_panel[i][j])<=2 then
        ...
        if ans=="3" and unlocked_symbol[2]==true then
          ...
          love.graphics.setLineWidth(linewidth)
          love.graphics.line(boxX-boxwidth*0.2,boxY-boxwidth*0.4,boxX+boxwidth*0.2,boxY-boxwidth*0.4,boxX+boxwidth*0.2,boxY,boxX-boxwidth*0.2,boxY,boxX-boxwidth*0.2,boxY+boxwidth*0.4,boxX+boxwidth*0.2,boxY+boxwidth*0.4)
        end
        ...
        if ans=="6"and (unlocked_symbol[4]==true or unlocked_symbol[6]==true)  and not isDemo  then
          ...
          drawSquare(boxX,boxY,boxwidth-linewidth+1,true)
          love.graphics.setColor(frontcolors[tonumber(ans)])
          love.graphics.line(boxX-boxwidth*0.36,boxY+boxwidth*0.12,boxX-boxwidth*0.12,boxY+boxwidth*0.12,boxX-boxwidth*0.12,boxY-boxwidth*0.12,boxX+boxwidth*0.12,boxY-boxwidth*0.12,boxX+boxwidth*0.12,boxY+boxwidth*0.12,boxX+boxwidth*0.36,boxY+boxwidth*0.12)
        end
        ...
        if ans=="9"and (unlocked_symbol[7]==true or unlocked_symbol[9]==true)  and not isDemo  then
          ...
          drawSquare(boxX,boxY,boxwidth-linewidth+1,true)
          love.graphics.setColor(frontcolors[tonumber(ans)])
          love.graphics.line(boxX-boxwidth*0.25,boxY-boxwidth*0.15,boxX+boxwidth*0.15,boxY-boxwidth*0.15,boxX+boxwidth*0.15,boxY+boxwidth*0.25)
  ...
  for i=1,mapWidth do
    ...
    for j=1,mapHeight do
      ...
      if(menu_panel[i][j]~="XXX")and(menu_panel[i][j]~="Sound")then
        ...
        if string.match(menu_panel[i][j],"%d+")~=nil and tonumber(string.match(menu_panel[i][j],"%d+"))>=4 and isDemo then
          menu_panel[i][j]="XXX"
