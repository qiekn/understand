...
function drawSquare(x,y,r,fill)
  if(fill)then
    love.graphics.rectangle("fill", x-r/2-love.graphics.getLineWidth()/2, y-r/2-love.graphics.getLineWidth()/2, r+love.graphics.getLineWidth(), r+love.graphics.getLineWidth())
  else
...
function drawTetris(x0,y0,r,str,fill)
  ...
  local corner={{linewidth/2,linewidth/2},{-linewidth/2,linewidth/2},{-linewidth/2,-linewidth/2},{linewidth/2,-linewidth/2}}
  local corner2={{-linewidth/2,linewidth/2},{-linewidth/2,-linewidth/2},{linewidth/2,-linewidth/2},{linewidth/2,linewidth/2}}
  FloodFill2(grid)
  for i=1,len(grid)do
    for j=1,len(grid[i])do
...
function drawSmallLine(x0,y0,r,str,fill)
  ...
  for i=2,len(pts) do
    ...
    local pp=0.75
    love.graphics.line(s1*pp+s3*(1-pp),s2*pp+s4*(1-pp),s3*pp+s1*(1-pp),s4*pp+s2*(1-pp))
  end
