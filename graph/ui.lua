function drawUI()
  if gamestate=="menu" then
    drawCross(screenWidth-uiSize*0.7,uiSize*0.7,uiSize*0.4,uiSize*0.15,math.pi/4,solve_tot>=level_num)
  else
  ...
  local pts={x4-d4*0.5,y4+d4*0.5,x4-d4*0.5,y4-d4*0.5,x4+d4*0.5,y4-d4,x4+d4*0.5,y4+d4}
  love.graphics.polygon("line",pts)
  if mute==0 then
    love.graphics.polygon("fill",pts)
  end
  if mute==2 then
    love.graphics.line(screenWidth-uiSize*2.7-uiSize*0.4,uiSize*0.7-uiSize*0.4,screenWidth-uiSize*2.7+uiSize*0.4,uiSize*0.7+uiSize*0.4)
  end
end
