        ...
        for xx=1,mapW[currentPanel]do
          for yy=1,mapH[currentPanel]do
            ...
            for k=1,len(FloodFillRes[currentPanel][i])do
              if (xx==FloodFillRes[currentPanel][i][k].x or xx==FloodFillRes[currentPanel][i][k].x-1) and (yy==FloodFillRes[currentPanel][i][k].y or yy==FloodFillRes[currentPanel][i][k].y-1) then
                cnt=cnt+1
              end
            end
            for k=1,len(FloodFillRes[currentPanel][n])do
              if (xx==FloodFillRes[currentPanel][n][k].x or xx==FloodFillRes[currentPanel][n][k].x-1) and (yy==FloodFillRes[currentPanel][n][k].y or yy==FloodFillRes[currentPanel][n][k].y-1) then
                cnt2=cnt2+1
              end
            end
