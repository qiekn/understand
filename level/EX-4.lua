    ...
    if len(visit[currentPanel])~=0 then
      ...
      for i=1,len(FloodFillRes[currentPanel]) do
        ...
        if FloodFillShapeCount[currentPanel][i]["C"]~=nil then
          if FloodFillShapeCount[currentPanel][i]["C"]~=1 or FloodFillShapeCount[currentPanel][i]["U"]~=nil or FloodFillShapeCount[currentPanel][i]["S"]~=nil or FloodFillShapeCount[currentPanel][i]["T"]~=nil then
            ans3=false
          end
        end
      end
