...
function newlevel.checkVictory()
  ...
  if currentPanel==4 then
    ...
    for i=2,len(visit[currentPanel])do
      ...
      print(visit[currentPanel][i-1].x,visit[currentPanel][i-1].y,visit[currentPanel][i].x,visit[currentPanel][i].y)
      ...
      if visit[currentPanel][i].y==4 and visit[currentPanel][i-1].y==4 and x0>=screenWidth-uiSize*0.7 and x1<=screenWidth-uiSize*0.7 then
        correct[currentPanel][3]=true
      end
      if visit[currentPanel][i].y==4 and visit[currentPanel][i-1].y==4 and x0<=screenWidth-uiSize*0.7 and x1>=screenWidth-uiSize*0.7 then
        correct[currentPanel][3]=true
