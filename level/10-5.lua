          ...
          for i1=1,mapW[currentPanel] do
            for j1=1,mapH[currentPanel]do
              if vvv[i1][j1]==ll then
                ...
                if i1<mapW[currentPanel] and visit_grid[currentPanel][i1+1][j1]==false and vvv[i1+1][j1]==10000 then
                  f2=true
                  vvv[i1+1][j1]=ll+1
                  if map[currentPanel][i1+1][j1].str~=" " then
                    flag=true
                ...
                if j1<mapH[currentPanel] and visit_grid[currentPanel][i1][j1+1]==false and vvv[i1][j1+1]==10000 then
                  f2=true
                  vvv[i1][j1+1]=ll+1
                  if map[currentPanel][i1][j1+1].str~=" " then
                    flag=true
