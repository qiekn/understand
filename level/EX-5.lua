        ...
        if map[currentPanel][visit[currentPanel][j].x][visit[currentPanel][j].y].str=="~" then
          if j==1 or j==len(visit[currentPanel])then
            ...
            if panel_in[map[currentPanel][visit[currentPanel][j].x][visit[currentPanel][j].y].num]=="none" then
              ans=false
            elseif panel_in[map[currentPanel][visit[currentPanel][j].x][visit[currentPanel][j].y].num]=="left" and direction[j-1]~="R" then
              ans=false
            elseif panel_in[map[currentPanel][visit[currentPanel][j].x][visit[currentPanel][j].y].num]=="right" and direction[j-1]~="L" then
              ans=false
            elseif panel_in[map[currentPanel][visit[currentPanel][j].x][visit[currentPanel][j].y].num]=="down" and direction[j-1]~="U" then
              ans=false
            elseif panel_in[map[currentPanel][visit[currentPanel][j].x][visit[currentPanel][j].y].num]=="up" and direction[j-1]~="D" then
              ans=false
            end
            if panel_out[map[currentPanel][visit[currentPanel][j].x][visit[currentPanel][j].y].num]=="none" then
              ans=false
            elseif panel_out[map[currentPanel][visit[currentPanel][j].x][visit[currentPanel][j].y].num]=="left" and direction[j]~="L" then
              ans=false
            elseif panel_out[map[currentPanel][visit[currentPanel][j].x][visit[currentPanel][j].y].num]=="right" and direction[j]~="R" then
              ans=false
            elseif panel_out[map[currentPanel][visit[currentPanel][j].x][visit[currentPanel][j].y].num]=="down" and direction[j]~="D" then
              ans=false
            elseif panel_out[map[currentPanel][visit[currentPanel][j].x][visit[currentPanel][j].y].num]=="up" and direction[j]~="U" then
              ans=false
            end
          end
        end
