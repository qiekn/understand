      ...
      if direction[i] ~= last_ch then
        if last_ch == "U" then
          if visit[currentPanel][i].y ~= 1 then
            ...
            if
              visit_order[visit[currentPanel][i].x][visit[currentPanel][i].y - 1] == 0
              or visit_order[visit[currentPanel][i].x][visit[currentPanel][i].y - 1] > i
            then
              ans2 = false
            end
          end
        ...
        if last_ch == "L" then
          if visit[currentPanel][i].x ~= 1 then
            ...
            if
              visit_order[visit[currentPanel][i].x - 1][visit[currentPanel][i].y] == 0
              or visit_order[visit[currentPanel][i].x - 1][visit[currentPanel][i].y] > i
            then
              ans2 = false
            end
          end
