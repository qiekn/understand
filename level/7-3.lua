  ...
  for i=1,len(visit[currentPanel])-2 do
    for j=i+1,len(visit[currentPanel])-1 do
      for k=j+1,len(visit[currentPanel]) do
        if map[currentPanel][visit[currentPanel][i].x][visit[currentPanel][i].y].str~=" " and map[currentPanel][visit[currentPanel][j].x][visit[currentPanel][j].y].str~=" " and map[currentPanel][visit[currentPanel][k].x][visit[currentPanel][k].y].str~=" " then
          if map[currentPanel][visit[currentPanel][i].x][visit[currentPanel][i].y].str~=map[currentPanel][visit[currentPanel][j].x][visit[currentPanel][j].y].str and map[currentPanel][visit[currentPanel][k].x][visit[currentPanel][k].y].str==map[currentPanel][visit[currentPanel][i].x][visit[currentPanel][i].y].str then
            ans2=false
          end
        end
      end
