...
intptr_t SteamAPI_SteamInput_v001();
...
struct InputDigitalActionData_t SteamAPI_ISteamInput_GetDigitalActionData(intptr_t,InputHandle_t,InputDigitalActionHandle_t);
...
struct InputAnalogActionData_t SteamAPI_ISteamInput_GetAnalogActionData(intptr_t,InputHandle_t,InputAnalogActionHandle_t);
...
struct InputMotionData_t SteamAPI_ISteamInput_GetMotionData(intptr_t,InputHandle_t);
void SteamAPI_ISteamInput_TriggerVibration(intptr_t,InputHandle_t,unsigned  usLeftSpeed,unsigned  usRightSpeed);
void SteamAPI_ISteamInput_SetLEDColor(intptr_t,InputHandle_t,uint8,uint8,uint8,unsigned  nFlags);
void SteamAPI_ISteamInput_TriggerHapticPulse(intptr_t,InputHandle_t,ESteamControllerPad,unsigned  usDurationMicroSec);
void SteamAPI_ISteamInput_TriggerRepeatedHapticPulse(intptr_t,InputHandle_t,ESteamControllerPad,unsigned  usDurationMicroSec,unsigned  usOffMicroSec,unsigned  unRepeat,unsigned  nFlags);
...
intptr_t SteamAPI_SteamController_v007();
...
struct InputDigitalActionData_t SteamAPI_ISteamController_GetDigitalActionData(intptr_t,ControllerHandle_t,ControllerDigitalActionHandle_t);
...
struct InputAnalogActionData_t SteamAPI_ISteamController_GetAnalogActionData(intptr_t,ControllerHandle_t,ControllerAnalogActionHandle_t);
...
struct InputMotionData_t SteamAPI_ISteamController_GetMotionData(intptr_t,ControllerHandle_t);
void SteamAPI_ISteamController_TriggerHapticPulse(intptr_t,ControllerHandle_t,ESteamControllerPad,unsigned  usDurationMicroSec);
void SteamAPI_ISteamController_TriggerRepeatedHapticPulse(intptr_t,ControllerHandle_t,ESteamControllerPad,unsigned  usDurationMicroSec,unsigned  usOffMicroSec,unsigned  unRepeat,unsigned  nFlags);
void SteamAPI_ISteamController_TriggerVibration(intptr_t,ControllerHandle_t,unsigned  usLeftSpeed,unsigned  usRightSpeed);
void SteamAPI_ISteamController_SetLEDColor(intptr_t,ControllerHandle_t,uint8,uint8,uint8,unsigned  nFlags);
...
intptr_t SteamAPI_SteamUGC_v014();
intptr_t SteamAPI_SteamGameServerUGC_v014();
...
bool SteamAPI_ISteamUGC_AddRequiredTagGroup(intptr_t,UGCQueryHandle_t,const char*);
...
SteamAPICall_t SteamAPI_ISteamUGC_CreateItem(intptr_t,AppId_t,EWorkshopFileType);
...
bool SteamAPI_ISteamUGC_SetItemTags(intptr_t,UGCUpdateHandle_t,const struct SteamParamStringArray_t*);
...
uint32 SteamAPI_ISteamUGC_GetSubscribedItems(intptr_t,PublishedFileId_t*,uint32);
...
bool SteamAPI_ISteamUGC_DownloadItem(intptr_t,PublishedFileId_t,bool);
bool SteamAPI_ISteamUGC_BInitWorkshopForGameServer(intptr_t,DepotId_t,const char*);
void SteamAPI_ISteamUGC_SuspendDownloads(intptr_t,bool);
...
// structs containing CSteamID are not packed at all on Windows
...
return ffi.load((x64 and win) and "steam_api64" or "steam_api")